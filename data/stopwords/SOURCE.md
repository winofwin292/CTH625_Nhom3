...
Đây là danh sách công khai, không tự soạn thêm từ.

Phần "cải tiến" nằm ở `src/text.py`: chuẩn hóa Unicode, thêm biến thể gạch dưới (phù hợp văn bản đã tách từ kiểu PhoBERT), và loại token chỉ gồm dấu câu/số.
